...
BOT_TOKEN = getenv("")
# -------------------------------------------------------
OWNER_USERNAME = getenv("OWNER_USERNAME","NobitaBhaskar")
# --------------------------------------------------------
BOT_USERNAME = getenv("BOT_USERNAME","Nobita_X_Music_Robot")
# --------------------------------------------------------
BOT_NAME = getenv("BOT_NAME","Nobita X Music")
# ---------------------------------------------------------
...
LOGGER_ID = int(getenv("LOGGER_ID", -4678038283))

# Get this value from @PURVI_HELP_BOT on Telegram by /id
OWNER_ID = int(getenv("OWNER_ID", 7169497576))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Nobita_X_Update")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/Nobita_X_Support_Chat")
